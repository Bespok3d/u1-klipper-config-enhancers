...
each `.b3`, cuts a release per plugin, assembles this repo's `index.json` sub-list as `U1 Klipper
Config Enhancers`, and registers it in `Bespok3d/main-index` (`lists/<repo>.json`). Secrets:
